...
kR = 0.00001; % The variance of the linear uncertainty for a 1m move for the right wheel
kL = 0.00001; % The variance of the linear uncertainty for a 1m move for the left wheel
smrNo=0;
