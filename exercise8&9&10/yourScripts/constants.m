...
kR = 0.00005; % The variance of the linear uncertainty for a 1m move for the right wheel
kL = 0.00005; % The variance of the linear uncertainty for a 1m move for the left wheel
smrNo=0;
%% Kalman filter Robot constants
global odoB_kf kR_kf kL_kf
odoB_kf = 0.3; % The separation between the two wheels
kR_kf = 0.00005; % The variance of the linear uncertainty for a 1m move for the right wheel
kL_kf = 0.00005; % The variance of the linear uncertainty for a 1m move for the left wheel
